...
stm_interfaces__srv__MotorService_Request__create()
{
  ...
  stm_interfaces__srv__MotorService_Request * msg = (stm_interfaces__srv__MotorService_Request *)allocator.allocate(sizeof(stm_interfaces__srv__MotorService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm_interfaces__srv__MotorService_Request));
  bool success = stm_interfaces__srv__MotorService_Request__init(msg);
  if (!success) {
...
stm_interfaces__srv__MotorService_Request__destroy(stm_interfaces__srv__MotorService_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stm_interfaces__srv__MotorService_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stm_interfaces__srv__MotorService_Request__Sequence__init(stm_interfaces__srv__MotorService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm_interfaces__srv__MotorService_Request * data = NULL;

  if (size) {
    data = (stm_interfaces__srv__MotorService_Request *)allocator.zero_allocate(size, sizeof(stm_interfaces__srv__MotorService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm_interfaces__srv__MotorService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stm_interfaces__srv__MotorService_Request__fini(&data[i - 1]);
      }
...
stm_interfaces__srv__MotorService_Request__Sequence__fini(stm_interfaces__srv__MotorService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stm_interfaces__srv__MotorService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm_interfaces__srv__MotorService_Request__Sequence * array = (stm_interfaces__srv__MotorService_Request__Sequence *)allocator.allocate(sizeof(stm_interfaces__srv__MotorService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm_interfaces__srv__MotorService_Request__Sequence__init(array, size);
  if (!success) {
...
stm_interfaces__srv__MotorService_Request__Sequence__destroy(stm_interfaces__srv__MotorService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm_interfaces__srv__MotorService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm_interfaces__srv__MotorService_Request__Sequence__are_equal(const stm_interfaces__srv__MotorService_Request__Sequence * lhs, const stm_interfaces__srv__MotorService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm_interfaces__srv__MotorService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm_interfaces__srv__MotorService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm_interfaces__srv__MotorService_Request);
    stm_interfaces__srv__MotorService_Request * data =
      (stm_interfaces__srv__MotorService_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm_interfaces__srv__MotorService_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stm_interfaces__srv__MotorService_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm_interfaces__srv__MotorService_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm_interfaces__srv__MotorService_Response * msg = (stm_interfaces__srv__MotorService_Response *)allocator.allocate(sizeof(stm_interfaces__srv__MotorService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm_interfaces__srv__MotorService_Response));
  bool success = stm_interfaces__srv__MotorService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stm_interfaces__srv__MotorService_Response__destroy(stm_interfaces__srv__MotorService_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stm_interfaces__srv__MotorService_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stm_interfaces__srv__MotorService_Response__Sequence__init(stm_interfaces__srv__MotorService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm_interfaces__srv__MotorService_Response * data = NULL;

  if (size) {
    data = (stm_interfaces__srv__MotorService_Response *)allocator.zero_allocate(size, sizeof(stm_interfaces__srv__MotorService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm_interfaces__srv__MotorService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stm_interfaces__srv__MotorService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stm_interfaces__srv__MotorService_Response__Sequence__fini(stm_interfaces__srv__MotorService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stm_interfaces__srv__MotorService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm_interfaces__srv__MotorService_Response__Sequence * array = (stm_interfaces__srv__MotorService_Response__Sequence *)allocator.allocate(sizeof(stm_interfaces__srv__MotorService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm_interfaces__srv__MotorService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stm_interfaces__srv__MotorService_Response__Sequence__destroy(stm_interfaces__srv__MotorService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm_interfaces__srv__MotorService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm_interfaces__srv__MotorService_Response__Sequence__are_equal(const stm_interfaces__srv__MotorService_Response__Sequence * lhs, const stm_interfaces__srv__MotorService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm_interfaces__srv__MotorService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm_interfaces__srv__MotorService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm_interfaces__srv__MotorService_Response);
    stm_interfaces__srv__MotorService_Response * data =
      (stm_interfaces__srv__MotorService_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm_interfaces__srv__MotorService_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stm_interfaces__srv__MotorService_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm_interfaces__srv__MotorService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
