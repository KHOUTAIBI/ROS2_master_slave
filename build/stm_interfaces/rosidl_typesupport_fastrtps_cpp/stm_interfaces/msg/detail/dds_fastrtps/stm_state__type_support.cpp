...
#include "stm_interfaces/msg/detail/stm_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const stm_interfaces::msg::STMState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm_interfaces::msg::STMState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _STMState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const stm_interfaces::msg::STMState *>(
...
{
  return max_serialized_size_STMState(full_bounded, 0);
}

static message_type_support_callbacks_t _STMState__callbacks = {
  "stm_interfaces::msg",
  "STMState",
...
static rosidl_message_type_support_t _STMState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_STMState__callbacks,
...
{
  return &stm_interfaces::msg::typesupport_fastrtps_cpp::_STMState__handle;
}
