...
#include "first_interfaces/msg/detail/custom__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // range_list
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // range_list
...
using _Custom__ros_msg_type = first_interfaces__msg__Custom;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: range_list
  {
    size_t size = ros_message->range_list.size;
    auto array_ptr = ros_message->range_list.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: range_list
  {
    ...
    if (ros_message->range_list.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->range_list);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->range_list, size)) {
      return "failed to create array for field 'range_list'";
    }
    auto array_ptr = ros_message->range_list.data;
...
size_t get_serialized_size_first_interfaces__msg__Custom(
  const void * untyped_ros_message,
...
static uint32_t _Custom__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_first_interfaces__msg__Custom(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_first_interfaces
size_t max_serialized_size_first_interfaces__msg__Custom(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_first_interfaces__msg__Custom(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_interfaces, msg, Custom)() {
